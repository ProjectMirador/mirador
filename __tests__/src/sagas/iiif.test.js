            ...
            windows: [
              {
                ...
                initialViewerConfig: { bounds: [10, 20, 30, 40], canvasId: 'https://example.org/iiif/canvas2' },
          ...
          config: {
            windows: [
              { canvasId: 'https://example.org/iiif/canvas4', manifestId: 'https://example.org/iiif/manifest1' },
              {
                ...
                initialViewerConfig: { bounds: [10, 10, 10, 10], canvasId: 'https://example.org/iiif/canvas2' },
              },
            ],
          },
          type: 'mirador/IMPORT_CONFIG',
