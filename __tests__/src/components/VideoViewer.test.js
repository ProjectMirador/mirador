...
describe('VideoViewer', () => {
  describe('render', () => {
    it('videoResources', () => {
      ...
      expect(video.querySelector('source:nth-of-type(1)')).toHaveAttribute(
        'type',
        'video/mp4',
      );
      expect(video.querySelector('source:nth-of-type(2)')).toHaveAttribute(
        'type',
        'video/mp4',
      );
    });
    ...
    it('captions', () => {
      ...
      const video = screen.getByTestId('video');
      expect(video.querySelector('track:nth-of-type(1)')).toHaveAttribute(
        'srcLang',
        'en',
      );
      expect(video.querySelector('track:nth-of-type(1)')).toHaveAttribute(
      ...
      expect(video.querySelector('track:nth-of-type(2)')).toHaveAttribute(
        'srcLang',
        'fr',
      );
      expect(video.querySelector('track:nth-of-type(2)')).toHaveAttribute(
