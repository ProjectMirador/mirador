...
describe('WindowViewSettings', () => {
  ...
  it('single should set the correct label active (by setting the secondary color)', () => {
    ...
    expect(screen.getByRole('menuitemradio', { name: /Book/ }).querySelector('svg')).not.toHaveClass('MuiSvgIcon-colorSecondary');
  });
  it('book should set the correct label active (by setting the secondary color)', () => {
    ...
    expect(screen.getByRole('menuitemradio', { name: /Single/ }).querySelector('svg')).not.toHaveClass('MuiSvgIcon-colorSecondary');
  });
