...
describe('ManifestRelatedLinks', () => {
  describe('when metadata is present', () => {
    ...
    it('renders the content in a CollapsibleSection', async () => {
      ...
      await user.click(
        screen.getByRole('button', { name: 'Collapse "Related" section' }),
      );
    ...
    it('renders manifest renderings information', () => {
      ...
      expect(screen.getByRole('link', { name: 'PDF Version' })).toHaveAttribute(
        'href',
    ...
    it('renders related information', () => {
      ...
      expect(
        screen.getByRole('link', { name: 'http://example.com/related' }),
      ).toHaveAttribute('href', 'http://example.com/related');
    ...
    it('renders manifest seeAlso information', () => {
      ...
      expect(
        screen.getByRole('link', { name: 'http://example.com/b' }),
      ).toHaveAttribute('href', 'http://example.com/b');
    });
