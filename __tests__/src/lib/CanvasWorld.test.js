...
describe('CanvasWorld', () => {
  ...
  describe('contentResourceToWorldCoordinates', () => {
    it('converts canvas coordinates to world offset by location', () => {
      expect(
        new CanvasWorld([canvases[1]]).contentResourceToWorldCoordinates({
          id: 'https://stacks.stanford.edu/image/iiif/fr426cg9537%2FSC1094_s3_b14_f17_Cats_1976_0005/full/full/0/default.jpg',
        }),
      ).toEqual([0, 0, 6501, 4421]);
      expect(
        new CanvasWorld(canvasSubset).contentResourceToWorldCoordinates({
          id: 'https://stacks.stanford.edu/image/iiif/rz176rt6531%2FPC0170_s3_Tree_Calendar_20081101_152516_0410/full/full/0/default.jpg',
        }),
      ).toEqual([6305, 0, 2848, 4288]);
    });
    it('supports RTL orientations', () => {
      expect(
        new CanvasWorld(canvasSubset, null, 'right-to-left').contentResourceToWorldCoordinates({
          id: 'https://stacks.stanford.edu/image/iiif/rz176rt6531%2FPC0170_s3_Tree_Calendar_20081101_152516_0410/full/full/0/default.jpg',
        }),
    ...
    it('supports TTB orientations', () => {
      expect(
        new CanvasWorld(canvasSubset, null, 'top-to-bottom').contentResourceToWorldCoordinates({
          id: 'https://stacks.stanford.edu/image/iiif/rz176rt6531%2FPC0170_s3_Tree_Calendar_20081101_152516_0410/full/full/0/default.jpg',
        }),
    ...
    it('supports BTT orientations', () => {
      expect(
        new CanvasWorld(canvasSubset, null, 'bottom-to-top').contentResourceToWorldCoordinates({
          id: 'https://stacks.stanford.edu/image/iiif/rz176rt6531%2FPC0170_s3_Tree_Calendar_20081101_152516_0410/full/full/0/default.jpg',
        }),
      ).toEqual([0, 0, 2848, 4288]);
    });
  ...
  describe('canvasScale', () => {
    it('is 1 when the canvas is laid out at its own size', () => {
      expect(
        new CanvasWorld([canvases[1]]).canvasScale('https://purl.stanford.edu/fr426cg9537/iiif/canvas/fr426cg9537_1'),
      ).toEqual(1);
    });
    it('is the ratio the canvas was shrunk by to match its neighbours', () => {
      ...
      expect(subject.canvasScale('https://purl.stanford.edu/fr426cg9537/iiif/canvas/fr426cg9537_1')).toEqual(6305 / 6501);
      expect(subject.canvasScale('https://purl.stanford.edu/rz176rt6531/iiif/canvas/rz176rt6531_1')).toEqual(1);
    });
    it('is 1 for a canvas that is not in the world', () => {
      expect(new CanvasWorld(canvasSubset).canvasScale('https://example.com/canvas/1')).toEqual(1);
    });
  });
  describe('canvasToWorldCoordinates', () => {
    it('converts canvas coordinates to world offset by location', () => {
      expect(
        new CanvasWorld([canvases[1]]).canvasToWorldCoordinates(
    ...
    it('supports RTL orientations', () => {
      expect(
        new CanvasWorld(canvasSubset, null, 'right-to-left').canvasToWorldCoordinates(
  ...
  describe('layerOpacityOfImageResource', () => {
    ...
    it('returns 0 if the layer is currently hidden', () => {
      ...
      expect(new CanvasWorld(canvases, layers).layerOpacityOfImageResource(tileSource1)).toEqual(0);
    });

    it('returns 1 if there is no opacity configuration for the layer', () => {
      expect(new CanvasWorld(canvases).layerOpacityOfImageResource(tileSource1)).toEqual(1);
      ...
      expect(new CanvasWorld(canvases, layers).layerOpacityOfImageResource(tileSource1)).toEqual(1);
    });
  ...
  describe('layerIndexOfImageResource', () => {
    ...
    it('returns actual index of the image annotation', () => {
      expect(new CanvasWorld(canvases).layerIndexOfImageResource(tileSource0)).toEqual(0);
    });
    ...
    it('returns the inverse of the configured index', () => {
      ...
      expect(new CanvasWorld(canvases, layers).layerIndexOfImageResource(tileSource0)).toEqual(0);
    });
  });
