 ...
 * workspaceReducer
 */
export const workspaceReducer = (state = { ...settings.workspace, windowIds: [] }, action) => {
  ...
  switch (action.type) {
    ...
    case ActionTypes.TOGGLE_THUMBNAIL_LABELS:
      return { ...state, showThumbnailLabels: action.showThumbnailLabels };
