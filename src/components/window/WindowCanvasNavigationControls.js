...
import ZoomControls from '../../containers/window/ZoomControls';
import ViewerInfo from '../../containers/window/ViewerInfo';
import ViewerNavigation from '../../containers/window/ViewerNavigation';
