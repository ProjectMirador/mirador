...
function ThumbnailCanvasGrouping({
  canvasGroupings,
...
const MemoizedThumbnailCanvasGrouping = memo(ThumbnailCanvasGrouping);

export { MemoizedThumbnailCanvasGrouping as ThumbnailCanvasGrouping };
