...
var ManifestListItem = function(options) {
...
ManifestListItem.prototype = {
  ...
  fetchTplData: function() {
    ...
    this.tplData.repoImage = (function() {
      ...
      var imageName = this.repoImages[repo || 'other'] || this.repoImages.other;

      return this.buildPath + this.logosPath + imageName;
    })();
...
module.exports = ManifestListItem;
