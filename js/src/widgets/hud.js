  ...
  $.Hud.prototype = {
    ...
    init: function() {
      ...
      this.element = jQuery(this.template({
        ...
        showAnno : typeof this.showAnno !== 'undefined' ? this.showAnno : this.canvasControls.annotations.annotationLayer,
      ...
      if (typeof this.showContextControls === 'undefined' || this.showContextControls){
