...
var store = exports.store = (0, _redux.createStore)(_index2.default, (0, _reduxDevtoolsExtension.composeWithDevTools)((0, _redux.applyMiddleware)(_reduxThunk2.default, loggerMiddleware)));

var actions = exports.actions = ActionCreators;
exports.default = { actions: actions, store: store };
...
*/
var aa=__webpack_require__(5),ba=__webpack_require__(1),m=__webpack_require__(16),p=__webpack_require__(2),v=__webpack_require__(3),da=__webpack_require__(17),ea=__webpack_require__(18),fa=__webpack_require__(19),ha=__webpack_require__(6);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(8), __webpack_require__(61)(module)))
...
var _ManifestForm = __webpack_require__(90);

var _ManifestForm2 = _interopRequireDefault(_ManifestForm);
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.setLastRequested = _this.setLastRequested.bind(_this);
    return _this;
  }

  _createClass(App, [{
    key: 'setLastRequested',
    value: function setLastRequested(requested) {
      this.setState({
    ...
    key: 'computedContent',
    value: function computedContent() {
      var manifest = this.props.manifests[this.state.lastRequested];
      if (manifest) {
    ...
    value: function render() {
      var manifestList = Object.keys(this.props.manifests).map(function (manifest) {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'App' },
        _react2.default.createElement(_ManifestForm2.default, { setLastRequested: this.setLastRequested }),
...
App.propTypes = {
  manifests: _propTypes2.default.instanceOf(Object).isRequired
};
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    fetchManifest: function fetchManifest(manifestUrl) {
      return dispatch(_index2.default.actions.fetchManifest(manifestUrl));
    }
  };
};
...
var _workspace = __webpack_require__(84);
...
var _manifests = __webpack_require__(86);

var _manifests2 = _interopRequireDefault(_manifests);
...
var workspaceReducer = function workspaceReducer() {
  ...
  switch (action.type) {
    case _actionTypes2.default.FOCUS_WINDOW:
...
exports.default = workspaceReducer;
...
var windowsReducer = function windowsReducer() {
  ...
  switch (action.type) {
    case _actionTypes2.default.ADD_WINDOW:
      return state.concat(Object.assign({}, action.payload));
    case _actionTypes2.default.REMOVE_WINDOW:
      return state.filter(function (window) {
        return window.id !== action.windowId;
      });
    case _actionTypes2.default.NEXT_CANVAS:
    ...
    case _actionTypes2.default.PREVIOUS_CANVAS:
      return state.map(function (window) {
        if (window.id === action.windowId) {
          return Object.assign({}, window, { canvasIndex: window.canvasIndex - 1 });
        }
...
exports.default = windowsReducer;
...
var manifestsReducer = function manifestsReducer() {
  ...
  switch (action.type) {
    case _actionTypes2.default.REQUEST_MANIFEST:
      return Object.assign({}, state, _defineProperty({}, action.manifestId, {
        isFetching: true
      }));
    case _actionTypes2.default.RECEIVE_MANIFEST:
      return Object.assign({}, state, _defineProperty({}, action.manifestId, {
        json: action.manifestJson,
        isFetching: false
      }));
    case _actionTypes2.default.RECEIVE_MANIFEST_FAILURE:
      return Object.assign({}, state, _defineProperty({}, action.manifestId, {
        error: action.error,
        isFetching: false
      }));
...
exports.default = manifestsReducer;
...
exports.nextCanvas = nextCanvas;
exports.previousCanvas = previousCanvas;
...
var _nodeFetch = __webpack_require__(88);
...
function focusWindow(windowId) {
  return { type: _actionTypes2.default.FOCUS_WINDOW, windowId: windowId };
}
...
function addWindow(options) {
  ...
  return { type: _actionTypes2.default.ADD_WINDOW, payload: Object.assign({}, defaultOptions, options) };
}

function removeWindow(windowId) {
  return { type: _actionTypes2.default.REMOVE_WINDOW, windowId: windowId };
}

function nextCanvas(windowId) {
  return { type: _actionTypes2.default.NEXT_CANVAS, windowId: windowId };
}

function previousCanvas(windowId) {
  return { type: _actionTypes2.default.PREVIOUS_CANVAS, windowId: windowId };
}

function requestManifest(manifestId) {
  return {
    type: _actionTypes2.default.REQUEST_MANIFEST,
...
function receiveManifest(manifestId, manifestJson) {
  return {
    type: _actionTypes2.default.RECEIVE_MANIFEST,
    manifestId: manifestId,
    manifestJson: manifestJson // Wrap in manifesto??
  };
}

function receiveManifestFailure(manifestId, error) {
  return {
    type: _actionTypes2.default.RECEIVE_MANIFEST_FAILURE,
    manifestId: manifestId,
    error: error
  };
}

function fetchManifest(manifestId) {
  return function (dispatch) {
    dispatch(requestManifest(manifestId));
    return (0, _nodeFetch2.default)(manifestId).then(function (response) {
      return response.json();
    }).then(function (json) {
      return dispatch(receiveManifest(manifestId, json));
    }).catch(function (error) {
      return dispatch(receiveManifestFailure(manifestId, error));
    });
  };
}
...
var displayContent = function displayContent(manifest) {
  if (manifest) {
    if (manifest.isFetching) {
      return '☕';
    } else if (manifest.error) {
...
var stateClass = function stateClass(manifest) {
  if (manifest) {
    if (manifest.isFetching) {
      return 'fetching';
    } else if (manifest.error) {
...
var Display = function Display(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'pre',
      { id: 'exampleManifest', className: stateClass(props.manifest) },
...
Display.propTypes = {
  manifest: _propTypes2.default.oneOfType([null, _propTypes2.default.object])
};
...
var ManifestForm = function (_Component) {
  _inherits(ManifestForm, _Component);

  function ManifestForm(props) {
    _classCallCheck(this, ManifestForm);

    var _this = _possibleConstructorReturn(this, (ManifestForm.__proto__ || Object.getPrototypeOf(ManifestForm)).call(this, props));
...
ManifestForm.propTypes = {
  fetchManifest: _propTypes2.default.func.isRequired,
  setLastRequested: _propTypes2.default.func.isRequired
};
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ManifestForm);
