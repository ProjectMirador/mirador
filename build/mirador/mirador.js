...
(function($) {
  ...
  $.Workspace.prototype = {
    ...
    bindEvents: function() {
      ...
      jQuery.subscribe('manifestToWorkspace', function(_, manifest, uiState, imageID) {
...
(function($) {
    ...
    $.ManifestListItem.prototype = {
        ...
        init: function() {
           var _this = this;
           //need a better way of calculating this
           //ultimately use 95% of space available
           ...
           remainingOffset = this.repoWidth + this.margin + this.metadataWidth + this.margin + this.imagesTotalWidth;
        ...
        fetchTplData: function() {
          ...
          for ( var i=0; i < manifest.sequences[0].canvases.length; i++) {
            //add a break to the loop if the total width is more than div width (don't add to tplData)
